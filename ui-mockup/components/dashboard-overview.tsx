...
import { Activity, Users, MessageSquare, TrendingUp, Server, AlertCircle, CheckCircle, Clock } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Overview of your GenAI ChatOps system performance and metrics.</p>
      </div>
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={responseTimeData}>
              ...
              <YAxis />
              <Tooltip />
              <Line type="monotone" dataKey="avgTime" stroke="#8884d8" strokeWidth={2} name="Avg Response Time (s)" />
            </LineChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
